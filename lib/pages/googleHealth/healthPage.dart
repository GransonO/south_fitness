...
class GoogleHealth extends StatefulWidget {
  @override
  _GoogleHealthState createState() => _GoogleHealthState();
}

class _GoogleHealthState extends State<GoogleHealth> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text('FitKit(South Fitness)'),
        ),
        body: Container(
